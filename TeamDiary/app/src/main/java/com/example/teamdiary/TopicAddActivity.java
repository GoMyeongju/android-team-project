...
public class TopicAddActivity extends AppCompatActivity {
    ...
    public void uploadStorage(Uri selectedImgUri) {
        ...
        final String img_name = tv_img_name.getText().toString();
        ...
        uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                //데이터베이스에 저장
                uploadDatabase(projectName, title, text, img_name);
    ...
    //데이터 베이스에 데이터 업로드
    public void uploadDatabase(String projectName, String title, String text, String img_uri){


        String key = databaseReference.child("test").push().getKey();
        DataAdd data_add = new DataAdd(projectName, title, text, img_uri);
